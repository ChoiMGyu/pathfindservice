...
public enum AuthenticationChkErrorCode implements BasicErrorCode {
    NOT_EMPTY(400, "NotEmpty", "인증 번호를 입력해주세요."),
    PATTERN(400, "Pattern", "인증번호는 숫자만 입력해주세요."),
    //CHANGE_EMAIL(409, "CHANGE_EMAIL", "인증 번호를 재발급 해주세요."),
    CHANGE_AUTHNUM(409, "CHANGE_AUTHNUM", "입력하신 인증 번호가 일치하지 않습니다."),
    TIME_OUT(409, "TIME_OUT", "인증 번호 유효 시간이 초과되어 다시 인증 번호를 발급해 주세요."),
