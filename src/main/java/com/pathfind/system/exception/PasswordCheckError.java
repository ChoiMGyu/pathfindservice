...
public enum PasswordCheckError implements BasicErrorCode{
    NOT_EMPTY(400, "NotEmpty", "비밀번호는 필수입니다."),
    PATTERN(400, "Pattern", "비밀번호는 8~20자 영문 대 소문자, 숫자, 특수문자를 사용하세요."),
    PASSWORD_CONFIRM_EMPTY(409, "PASSWORD_CONFIRM_EMPTY", "비밀번호 확인을 진행해주세요."),
    NOT_SAME(409, "PASSWORD_NOT_SAME", "패스워드가 일치하지 않습니다.");
