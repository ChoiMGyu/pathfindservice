/*
 * 클래스 기능 : 사용자로부터 받은 아이디, 이메일의 유효성, 일치 여부 확인을 위해 사용되는 dto 클래스
...
@Schema(name = "IdEmailExistVCRequest", description = "유저 아이디, 이메일 유효성, 일치 여부 확인에 쓰이는 dto")
@Data
public class IdEmailExistVCRequest {
